...
export default function EditProfilePage() {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            ...
            if (result.success && result.data) {
                ...
                const userData: UserData = ((rawData.data as Record<string, unknown>) ?? rawData) as UserData;
                reset({
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="mb-8">
                <h1 className="text-white text-2xl font-bold tracking-wide">Edit Profile</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex justify-end gap-3">
                    <button
                        ...
                        className="bg-transparent border border-white/10 hover:bg-white/5 text-white text-sm font-bold py-3 px-8 rounded-lg tracking-widest uppercase transition"
                    >
                        Cancel
                    </button>
                    <button
